  ...
  return (
    ...
    >
      ...
      <div className="container-muva">
        ...
        >
          <div className="eyebrow !text-muva-sand">{t("visit.eyebrow", locale)}</div>
